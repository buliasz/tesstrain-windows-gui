...
> Tesseract language training Windows GUI v6.2 for Tesseract and Tesstrain. Source AutoHotKey script file can be compiled to an .exe (example command can be 
